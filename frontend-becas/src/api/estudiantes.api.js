...
export const getEstudiantes    = (page, limit) => api.get(`/estudiantes?page=${page}&limit=${limit}`);
export const getEstudiante     = (id)          => api.get(`/estudiantes/${id}`);
export const createEstudiante  = (datos)       => api.post("/estudiantes", datos);
export const updateEstudiante  = (id, datos)   => api.put(`/estudiantes/${id}`, datos);
...
export const cambiarCarrera    = (id, datos)   => api.patch(`/estudiantes/${id}/carrera`, datos);
